export class AppsConst {
    ...
    static readonly social_media = {
        ...
        phone_pavi: '+33 07 69 73 79 95',
        phone_dilaksan: '+33 06 58 09 42 70',

        insta_pavi:'https://www.instagram.com/pavi_sh22/',

        insta_dilaksan:'https://www.instagram.com/dilaksan_raj',
